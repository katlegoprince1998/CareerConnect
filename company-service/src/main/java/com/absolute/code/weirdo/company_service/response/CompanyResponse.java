...
public record CompanyResponse (Long companyId, String name, String logo, String website, String industry, String description
, Location location, ContactInfo contactInfo, Long userId) {}
